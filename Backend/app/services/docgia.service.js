class DocGiaService {
    ...
    extractDocGiaData(payload) {
        if (!payload.madocgia || !payload.holot || !payload.ten || !payload.ngaysinh || 
            !payload.phai || !payload.diachi || !payload.dienthoai) {
            throw new Error("Missing required fields: 'madocgia', 'holot', 'ten', 'ngaysinh', 'phai', 'diachi', 'dienthoai', and/or 'password'");
        }
        ...
        const docgia = {
            ...
            password: payload.password // Thêm trường mật khẩu
        };
